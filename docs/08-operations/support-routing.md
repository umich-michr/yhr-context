...
2. Identify the actor and current account context.
3. Confirm authentication.
4. Confirm participant or institutional account status.
5. Confirm imported study existence and publishability.
6. Confirm operational study dates, active state, and archive state.
7. Confirm study membership.
8. Confirm participant visibility and activity.
9. Confirm exact, partial, interest, and exclusion state.
10. Confirm interested-participant workflow state.
11. Confirm the requested operation:
    - Profile access
    - Messaging
    - Questionnaire editing
    - Notification delivery
    - Export
12. Review `PHI_AUDIT`, Redis, application logs, and email-delivery evidence as applicable.
