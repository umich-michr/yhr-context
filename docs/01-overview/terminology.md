...
| Discoverable visibility      | Participant choice that permits the participant to participate in study-facing matching and, when otherwise matched, appear to study teams before interest.                                                                                                                                                                    |
| Restricted visibility        | Participant choice that excludes the participant from pre-interest study-side matching while still allowing participant-facing recommendations. After successful interest, the participant is visible to the applicable study team through the Interested Participants workflow but remains hidden from unrelated study teams. |
...
| Partial eligibility match    | Eligibility result `MAYBE`: known participant properties do not establish a mismatch, but one or more referenced properties are missing and the available information is insufficient to decide the applicable expressions.                                                                                                    |
...
| Unknown participant property | A missing or null participant-profile property. When referenced by an eligibility expression, it produces `MAYBE`.                                                                                                                                                                                                             |
