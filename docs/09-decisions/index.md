...
Before answering a question about behavior not explicitly documented as authoritative, consult
[Open questions](open-questions.md).

For AI-assisted study-posting authoring and analytics questions, consult
...
1. Update the business rules if the decision is cross-cutting.
1. Remove or mark the question resolved.
1. Regenerate `llms.txt` from `context-map.yaml` if routing changes.
